...
RUN curl --fail -LsS https://git.zx2c4.com/WireGuard/snapshot/WireGuard-${WIREGUARD_VERSION}.tar.xz | tar xJ && \
    cd /WireGuard-${WIREGUARD_VERSION}/src && \
    ...
    rm -rf /WireGuard-${WIREGUARD_VERSION}
